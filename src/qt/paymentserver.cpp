...
const QString BITCOIN_IPC_PREFIX("egcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click egcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start egcoin: click-to-pay handler");
    else
...
{
    // clicking on egcoin: URLs creates FileOpen events on the Mac:
